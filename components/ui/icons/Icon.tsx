  ...
  const getPath = () => {
    switch (name) {
      ...
      case 'reports':
        ...
        case 'notifications':
          return (
            <path fillRule="evenodd" d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zm-1 16a1 1 0 102 0h-2z" clipRule="evenodd" />
        );
      case 'jobs':
        return (
          <>
