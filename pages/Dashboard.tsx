        ...
        <Layout title="Dashboard - SureSight">
            <AuthGuard>
                <div className="container mx-auto px-4 py-6">
                            ...
                            <Card>
                                <div className="p-8 text-center">
                                    ...
                                    <p className="text-gray-500 text-sm">
                                        {statusFilter !== 'all' 
                                            ? `No reports with status "${formatStatus(statusFilter)}". Try changing the filter.` 
                                        ...
                                        <div className="p-4">
                                            <div className="flex justify-between items-start">
                                                <div>
                                                    ...
                                                    <p className="text-gray-600">{report.property?.address_line1}</p>
                    ...
                    <Card>
                        <div className="p-6">
                            <h2 className="text-xl font-medium text-gray-700 mb-4">Quick Upload</h2>
