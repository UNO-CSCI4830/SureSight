...
const SignUp: React.FC = () => {
  ...
  const handleSignUp = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const passwordMatchResult = formValidation.validatePasswordMatch(password, confirmPassword);
    if (!passwordMatchResult.isValid) {
      newErrors.confirmPassword = passwordMatchResult.message || 'Passwords do not match';
    }
    ...
    try {
      ...
      if (err.message.includes('already registered')) {
        ...
        setStatusMessage({
          text: err.message || 'An error occurred during signup. Please try again later.',
          type: 'error'
        });
      }
    } finally {
