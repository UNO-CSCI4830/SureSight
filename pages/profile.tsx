    ...
    try {
      ...
      if (userData.roleProfile) {
        ...
        if (profileData.role === "homeowner") {
          ...
          profileData.years_experience =
            roleProfile.years_experience || undefined;
          ...
          profileData.company_name = roleProfile.company_name;
          profileData.license_number =
            roleProfile.adjuster_license || undefined;
          profileData.territories = roleProfile.territories || undefined;
          profileData.certification_verified =
            roleProfile.certification_verified;
        }
      }
          ...
          {profile.role === "contractor" && (
            <>
              ...
              <div>
                ...
                <p className="mt-1 text-lg">
                  {profile.service_area || "Not provided"}
                </p>
              </div>
          ...
          {profile.role === "adjuster" && (
            <>
              ...
              <div>
                ...
                <p className="mt-1 text-lg">
                  {profile.certification_verified ? "Yes" : "No"}
                </p>
              </div>
            </>
          )}
        ...
        <div>
          ...
          {selectedRole !== profile.role && (
            <p className="mt-1 text-xs text-amber-600">
              Changing your account type will update the information you need to
              provide.
            </p>
          )}
        </div>
