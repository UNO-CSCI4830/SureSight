      ...
      try {
        ...
        if (storedUserDbId) {
          const { data: userById, error: userByIdError } = await supabase
            .from("users")
            .select(
              "id, auth_user_id, first_name, last_name, phone, role, email"
            )
      ...
      <Layout title="Profile Complete | SureSight">
        <Card className="max-w-md mx-auto text-center py-10">
          ...
          <p className="text-gray-600 mb-6">
            Your profile has been set up. You'll be redirected to your dashboard
            shortly.
          </p>
        </Card>
      </Layout>
  ...
  return (
    <Layout title="Complete Your Profile | SureSight">
      <div className="max-w-md mx-auto">
        ...
        <Card>
          {error && (
            <StatusMessage type="error" text={error} className="mb-6" />
          )}
